...
| <si-docs-color style="background: #a733bc;"></si-docs-color> | <si-docs-color style="background: #a733bc;"></si-docs-color> | `$element-status-critical`             | Critical                                      | `$siemens-data-orchid-500` | `$siemens-data-orchid-500` |
